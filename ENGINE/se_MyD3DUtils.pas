...
// Για σφαίρες κλπ...
  ...
  PD3DRMVertexArray = ^TD3DRMVertexArray;
  TD3DRMVertexArray = array[0..$FFFE] of TD3DRMVertex;
...
procedure GetRotationMatrix(out mat: TD3DMatrix; x, y, z: TD3DValue; aspect: TD3DValue = 1.0);
var
  matRotateX, matRotateY, matRotateZ: TD3DMatrix;
begin
